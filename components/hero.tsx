        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left flex flex-col md:flex-row">
            ...
            <div className="md:w-[640px]">
              ...
              "Capture, showcase, and connect with our innovative web app designed exclusively for photographers. Seamlessly manage your portfolio, leverage advanced editing tools, and engage with a vibrant community of fellow artists to elevate your craft and career."
              </p>
              {/* Buttons */}
              <div
