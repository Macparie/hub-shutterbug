          ...
          <div>
            ...
            <div className="mb-8">
              <div className="flex flex-wrap justify-center md:justify-start -m-1.5">
                ...
                <button className={`relative font-medium text-gray-800 text-sm pl-3 pr-1.5 py-1.5 border rounded-full inline-flex m-1.5 ${category === '5' ? 'bg-blue-100 border-blue-300' : 'bg-white border-gray-200'}`} onClick={() => setCategory('5')}>
                  <div className="flex items-center justify-center">
                    <span>Nature Inspired</span>
                    <span className={`text-xs font-semibold px-1 py-px rounded-full ml-2 ${category === '3' ? 'text-white bg-blue-300' : 'text-gray-400 bg-gray-100'}`}>12.7K</span>
                  </div>
                </button>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="max-w-sm mx-auto sm:max-w-none grid gap-6 sm:grid-cols-2 md:grid-cols-3 items-start" data-aos-id-inpspiration>
                {/* 1st Gallery Image */}
                <a className="relative group hover:shadow-xl transition duration-150 ease-in-out" style={!['0', '1', '5', '3'].includes(category) ? { display: 'none' } : {}} href="#0" data-aos="fade-down" data-aos-anchor="[data-aos-id-inpspiration]">
                ...
                {/* 2nd Gallery Image */}
                <a className="relative group hover:shadow-xl transition duration-150 ease-in-out" style={!['0', '2', '5', '3'].includes(category) ? { display: 'none' } : {}} href="#0" data-aos="fade-down" data-aos-anchor="[data-aos-id-inpspiration]" data-aos-delay="100">
                  ...
                  <div className="md:hidden md:group-hover:block absolute bottom-0 left-0 right-0 p-4">
                    ...
                    <div className="relative flex justify-between">
                      ...
                      <div className="flex items-center">
                        <Image className="shrink-0 w-10 h-10 rounded-full mr-4" src={Author01} width={40} height={40} alt="Author 01" />
                        <div className="truncate">
                          <div className="font-bold text-white truncate">Ada Macparie</div>
                          <div className="text-xs text-white opacity-60 truncate">@Macparie-the-creative</div>
                        </div>
                      </div>
                      {/* Right side */}
