  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto text-center pb-12">
        ...
        <h1 className="h2 font-cabinet-grotesk">You've been invited by Macparie to join Creative</h1>
      </div>
      {/* Form */}
        ...
        <form>
          <div className="flex flex-wrap mb-4">
            <div className="w-full">
              ...
              <input id="email" type="email" className="form-input w-full text-gray-800" defaultValue="Macparie@gmail.com" required />
            </div>
          </div>
          <div className="flex flex-wrap mb-4">
            <div className="w-full">
